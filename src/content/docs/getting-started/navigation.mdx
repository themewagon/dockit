...
### 1. **Installation** → [Setup Guide](/dockit/getting-started/installation)

Set up DocKit locally and get your development environment ready.

### 2. **Configuration** → [Global Settings](/dockit/getting-started/global-settings/configuration)

Customize DocKit to match your brand and requirements.

### 3. **Content Creation** → [Writing Content](/dockit/guides/content)

Learn how to write and organize your documentation content.

### 4. **Customization** → [Theming Guide](/dockit/guides/customization)

Make DocKit uniquely yours with custom styling and components.

### 5. **Deployment** → [Going Live](/dockit/guides/deployment)
...
[Install DocKit →](/dockit/getting-started/installation)

_Need inspiration? Check out our [showcase](/dockit/resources/showcase) of beautiful DocKit sites._

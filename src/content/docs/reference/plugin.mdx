...
sidebar:
  label: "[seti:html] Plugins Reference"
---
...
Learn more about using a Starlight plugin in the [Configuration Reference](/dockit/reference/configuration/#plugins) or visit the [plugins showcase](/dockit/resources/plugins/#plugins) to see a list of available plugins.
